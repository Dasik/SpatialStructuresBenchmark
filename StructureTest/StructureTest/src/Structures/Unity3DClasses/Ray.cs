...
namespace UnityEngine
{
	...
	public struct Ray
	{
		...
		{
			return String.Format("Origin: {0}, Dir: {1}", (object)this.m_Origin, (object)this.m_Direction);
		}
		...
		{
			return String.Format("Origin: {0}, Dir: {1}", (object)this.m_Origin.ToString(format), (object)this.m_Direction.ToString(format));
		}
	}
}
