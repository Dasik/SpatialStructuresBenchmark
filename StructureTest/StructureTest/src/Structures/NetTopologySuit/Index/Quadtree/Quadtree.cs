...
namespace NetTopologySuite.Index.Quadtree
{
    ...
    [System.Serializable]
#endif
    public class Quadtree<T> : ISpatialIndex<T>, System.Collections.Generic.IEnumerable<T>
    {
        /// <summary>
        ...
        public IEnumerator<T> GetEnumerator()
        {
            ...
            while (stack.Count > 0)
            {
                ...
                foreach (var o in currentElement.Items)
                    yield return o;
                foreach (var node in currentElement.Subnode)
                {
                    if (node!=null)
                    stack.Push(node);
                }
